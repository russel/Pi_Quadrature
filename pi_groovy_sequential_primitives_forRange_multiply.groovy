...
println ( "==== Groovy Sequential Primitives ForRange Multiply pi = " + pi )
println ( "==== Groovy Sequential Primitives ForRange Multiply iteration count = " + n ) 
println ( "==== Groovy Sequential Primitives ForRange Multiply elapse = " + elapseTime )
