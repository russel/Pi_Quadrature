...
public class Pi_Futures_Java7_Batched {
  ...
  private static void execute(final int numberOfTasks) {
    ...
    Output.out(Pi_Futures_Java7_Batched.class, pi, n, elapseTime, numberOfTasks);
  }

  public static void main(final String[] args) {
    Pi_Futures_Java7_Batched.execute(1);
    Pi_Futures_Java7_Batched.execute(2);
    Pi_Futures_Java7_Batched.execute(8);
    Pi_Futures_Java7_Batched.execute(32);
  }
}
