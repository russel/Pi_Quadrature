...
public class Pi_ForkJoinCollection_Java8 {
  ...
  private static void execute(final int numberOfTasks) {
    ...
    Output.out(Pi_ForkJoinCollection_Java8.class, pi, n, elapseTime, numberOfTasks);
  }

  public static void main(final String[] args) {
    Pi_ForkJoinCollection_Java8.execute(1);
    Pi_ForkJoinCollection_Java8.execute(2);
    Pi_ForkJoinCollection_Java8.execute(8);
    Pi_ForkJoinCollection_Java8.execute(32);
  }
}
