...
/*
 *  Use the GPars fork of extra166y (rather than extra166y itself) as
 *  it is a dependency of this project anyway.
 */
...
public class Pi_ParallelArray_Java7 {
  ...
  private static void execute(final int numberOfTasks) {
    ...
    Output.out(Pi_ParallelArray_Java7.class, pi, n, elapseTime, numberOfTasks);
  }
  public static void main(final String[] args) {
    Pi_ParallelArray_Java7.execute(1);
    Pi_ParallelArray_Java7.execute(2);
    Pi_ParallelArray_Java7.execute(8);
    Pi_ParallelArray_Java7.execute(32);
  }
}
