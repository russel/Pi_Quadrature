...
public class Pi_ParallelStream_Java8_Alt {
  ...
  public static void main(final String[] args) {
    Pi_ParallelStream_Java8_Alt.execute(1);
    Pi_ParallelStream_Java8_Alt.execute(2);
    Pi_ParallelStream_Java8_Alt.execute(8);
    Pi_ParallelStream_Java8_Alt.execute(32);
  }
}
