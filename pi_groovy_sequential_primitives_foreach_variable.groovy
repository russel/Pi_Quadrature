...
println ( "==== Groovy Sequential Primitives Foreach Variable pi = " + pi )
println ( "==== Groovy Sequential Primitives Foreach Variable iteration count = " + n ) 
println ( "==== Groovy Sequential Primitives Foreach Variable elapse = " + elapseTime )
