...
println ( "==== Groovy Sequential Primitives Foreach Power pi = " + pi )
println ( "==== Groovy Sequential Primitives Foreach Power iteration count = " + n ) 
println ( "==== Groovy Sequential Primitives Foreach Power elapse = " + elapseTime )
