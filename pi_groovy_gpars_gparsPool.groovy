...
void execute ( final int numberOfTasks ) {
  GParsPool.withPool {
    ...
    System.out.println ( "==== Groovy GPars GParsPool pi = " + pi )
    System.out.println ( "==== Groovy GPars GParsPool iteration count = " + n )
    System.out.println ( "==== Groovy GPars GParsPool elapse = " + elapseTime )
    System.out.println ( "==== Groovy GPars GParsPool processor count = " + Runtime.getRuntime ( ).availableProcessors ( ) )
    System.out.println ( "==== Groovy GPars GParsPool task count = " + numberOfTasks )
  }
}
