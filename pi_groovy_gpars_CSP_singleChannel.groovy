...
void execute ( final int numberOfTasks ) {
  ...
  processes << new CSProcess ( ) {
    public void run ( ) {
      ...
      System.out.println ( "==== Groovy GPars CSP Single pi = " + pi )
      System.out.println ( "==== Groovy GPars CSP Single iteration count = " + n )
      System.out.println ( "==== Groovy GPars CSP Single elapse = " + elapseTime )
      System.out.println ( "==== Groovy GPars CSP Single processor count = " + Runtime.getRuntime ( ).availableProcessors ( ) )
      System.out.println ( "==== Groovy GPars CSP Single task count = " + numberOfTasks )
    }
  } ;
